...
class LoadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create load" do
    assert_difference('Load.count') do
      post loads_url, params: { load: { date: @load.date, ev: @load.ev, home: @load.home, sun: @load.sun } }
    end
  ...
  test "should update load" do
    patch load_url(@load), params: { load: { date: @load.date, ev: @load.ev, home: @load.home, sun: @load.sun } }
